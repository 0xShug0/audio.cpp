...
private:
    ...
    std::unique_ptr<IrodoriConditionRuntime> condition_;
    std::unique_ptr<IrodoriRfRuntime> rf_;
    std::unique_ptr<IrodoriCodecRuntime> codec_;
