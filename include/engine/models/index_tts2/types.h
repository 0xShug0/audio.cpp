...
struct IndexTTS2Config {
    ...
    std::string bpe_model = "bpe.model";
    ...
    std::string gpt_checkpoint = "gpt.pth";
    std::string w2v_stat = "wav2vec2bert_stats.pt";
    std::string s2mel_checkpoint = "s2mel.pth";
    std::string emo_matrix = "feat2.pt";
    std::string spk_matrix = "feat1.pt";
    std::vector<int64_t> emo_num;
    std::string qwen_emo_path = "qwen0.6bemo4-merge/";
    std::string vocoder_type = "bigvgan";
    std::string vocoder_name = "nvidia/bigvgan_v2_22khz_80band_256x";
};
