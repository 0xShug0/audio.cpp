...
| **parakeet_tdt** | ASR | 25 European languages, auto-detect | [@dleiferives](https://github.com/dleiferives) | [Parakeet-TDT 0.6B v3](parakeet_tdt.md) FastConformer-TDT ASR with safetensors and standalone F32/16-bit/Q8 GGUF loading, offline full-context, bounded-window long-form, and buffered streaming |
