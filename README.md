...
| **coqui_speedy_speech** | TTS | en | GGUF F32 | [@DrewThomasson](https://github.com/DrewThomasson) | [Coqui SpeedySpeech](docs/community_models/coqui_speedy_speech.md) feed-forward LJSpeech synthesis with HiFi-GAN v2 |
