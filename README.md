...
| **parakeet_tdt** | ASR | 25 European languages, auto-detect | GGUF F32/16/Q8, Stream | [@dleiferives](https://github.com/dleiferives) | [Parakeet-TDT 0.6B v3](docs/community_models/parakeet_tdt.md) FastConformer-TDT ASR with offline full-context, bounded-window long-form, and buffered streaming |
