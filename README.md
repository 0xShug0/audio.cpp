...
| **sanotts** | TTS | en, vi, id, cs, de, es, fr, it, pt, ro, ru, tr | GGUF FP32 | Ashish [@voidash](https://github.com/voidash) | [sanoTTS voice family](docs/community_models/sanotts.md) sixteen voices from 294k to 2.27M parameters, native offline synthesis |
