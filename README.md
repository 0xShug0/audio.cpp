...
| **sanotts** | TTS | en | GGUF FP32 | Ashish [@voidash](https://github.com/voidash) | [sanoTTS heart-nano](docs/community_models/sanotts.md) 294k-parameter native offline synthesis |
