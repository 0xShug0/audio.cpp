...
engine::modules::BigVganVocoderConfig parse_bigvgan_config(
    ...
    const auto root = engine::io::json::parse_file(assets.paths.bigvgan_config_path);
...
IndexTTS2BigVganVocoder::IndexTTS2BigVganVocoder(
    ...
    component_ = engine::modules::BigVganVocoderComponent::load_from_safetensors(
        assets_->paths.bigvgan_weights_path,
        std::move(backend),
