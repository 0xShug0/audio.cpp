...
IndexTTS25StyleEncoder::IndexTTS25StyleEncoder(
    std::shared_ptr<const IndexTTS25Assets> assets,
    core::BackendConfig backend,
    engine::assets::TensorStorageType weight_storage_type)
    : assets_(std::move(assets)) {
    if (assets_ == nullptr) {
        throw std::runtime_error("IndexTTS2.5 style encoder requires assets");
    }
...
IndexTTS25StyleEmbedding IndexTTS25StyleEncoder::embed_fbank(
...
void IndexTTS25StyleEncoder::release_graph() {
